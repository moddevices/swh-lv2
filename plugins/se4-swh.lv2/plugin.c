...
static void cleanupSe4(LV2_Handle instance)
{
...
static void connectPortSe4(LV2_Handle instance, uint32_t port, void *data)
{
  Se4 *plugin = (Se4 *)instance;
...
static LV2_Handle instantiateSe4(const LV2_Descriptor *descriptor,
...
static void runSe4(LV2_Handle instance, uint32_t sample_count)
{
  Se4 *plugin_data = (Se4 *)instance;
  ...
  const float attenuation = *(plugin_data->attenuation);
  float amplitude;
  float gain_exp;
...
static const LV2_Descriptor se4Descriptor = {
